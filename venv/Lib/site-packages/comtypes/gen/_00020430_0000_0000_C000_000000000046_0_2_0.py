...
__all__ = [ 'OLE_YSIZE_CONTAINER', 'OLE_ENABLEDEFAULTBOOL',
           'FONTITALIC', 'OLE_COLOR', 'OLE_YSIZE_PIXELS', 'IFontDisp',
           'Font', 'IFontEventsDisp', 'Color', 'IFont', 'Default',
           'FONTSIZE', 'OLE_YSIZE_HIMETRIC', 'FONTNAME',
           'FONTUNDERSCORE', 'Picture', 'OLE_TRISTATE',
           'LoadPictureConstants', 'FONTBOLD', 'Checked',
           'OLE_OPTEXCLUSIVE', 'FONTSTRIKETHROUGH', 'StdFont',
           'OLE_YPOS_CONTAINER', 'OLE_CANCELBOOL',
           'OLE_YPOS_HIMETRIC', 'OLE_YPOS_PIXELS', 'StdPicture',
           'OLE_XSIZE_CONTAINER', 'OLE_XPOS_HIMETRIC', 'Gray',
           'OLE_XPOS_PIXELS', 'Unchecked', 'IPictureDisp',
           'OLE_HANDLE', 'OLE_XSIZE_PIXELS', 'IPicture',
           'OLE_XPOS_CONTAINER', 'Monochrome', 'VgaColor',
           'OLE_XSIZE_HIMETRIC', 'FontEvents']
from comtypes import _check_version; _check_version('', 1610191035.095726)
